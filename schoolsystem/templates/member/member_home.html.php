            ...
            <?php foreach ($posts as $post): ?>
                <div class="rounded-xl border border-gray-200 shadow-md p-6 hover:shadow-lg transition-shadow bg-blue-50">
                    ...
                    <div class="flex items-center text-sm text-gray-500 gap-6 w-full">
                        ...
                        <a href="../member/detailPost.php?postId=<?= htmlspecialchars($post['postId'], ENT_QUOTES, 'UTF-8')?>" class="items-center justify-center flex w-full gap-2 bg-blue-200 text-blue-600 hover:bg-blue-500 hover:text-white hover:scale-105 px-4 py-2 rounded-full font-semibold transition duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
